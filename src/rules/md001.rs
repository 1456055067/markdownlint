...
mod tests {
    ...
    fn test_md001_valid_increment() {
        ...
        tokens.push(create_atx_heading(1, 1, &mut tokens));
        tokens.push(create_atx_heading(2, 2, &mut tokens));
        tokens.push(create_atx_heading(3, 3, &mut tokens));
    ...
    fn test_md001_skip_level() {
        let mut tokens = Vec::new();
        tokens.push(create_atx_heading(1, 1, &mut tokens));
        tokens.push(create_atx_heading(2, 3, &mut tokens)); // Skip from h1 to h3
    ...
    fn test_md001_decrease_is_ok() {
        ...
        tokens.push(create_atx_heading(2, 2, &mut tokens));
        tokens.push(create_atx_heading(3, 3, &mut tokens));
        tokens.push(create_atx_heading(4, 1, &mut tokens)); // Back to h1 is ok
    ...
    fn test_md001_with_front_matter_title() {
        let mut tokens = Vec::new();
        tokens.push(create_atx_heading(4, 2, &mut tokens)); // h2 after front matter title is ok
    ...
    fn test_md001_setext_headings() {
        let mut tokens = Vec::new();
        tokens.push(create_setext_heading(1, 1, &mut tokens)); // h1
        tokens.push(create_setext_heading(4, 2, &mut tokens)); // h2
    ...
    fn test_md001_multiple_skips() {
        let mut tokens = Vec::new();
        tokens.push(create_atx_heading(1, 1, &mut tokens));
        tokens.push(create_atx_heading(2, 4, &mut tokens)); // Skip from h1 to h4
        tokens.push(create_atx_heading(3, 6, &mut tokens)); // Skip from h4 to h6
